...
class MinesweeperModel(nn.Module):
    def __init__(self):
        ...
        self.conv0 = nn.Conv2d(6, 64, kernel_size=3, padding=1)  # 6 input channels
        self.conv1 = nn.Conv2d(64, 256, kernel_size=5, padding=2)
        self.conv2 = nn.Conv2d(256, 64, kernel_size=5, padding=2)
