...
def create_model(input_shape: tuple[int, ...], output_shape: tuple[int, ...]) -> TfKerasModel:
    ...
    model = Sequential(
        [
            ...
            Conv2D(24, (3, 3), activation='relu', padding='same', name='conv0'),
            Conv2D(80, (5, 5), activation='relu', padding='same', name='conv1'),
            Conv2D(40, (5, 5), activation='relu', padding='same', name='conv2'),
            Conv2D(16, (3, 3), activation='relu', padding='same', name='conv3'),
